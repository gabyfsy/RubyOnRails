...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { tweet: @tweet.tweet, usuario_id: @tweet.usuario_id } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { tweet: @tweet.tweet, usuario_id: @tweet.usuario_id } }
